    ...
    return BlocBuilder<OrderCubit, OrderState>(
      builder: (context, state) {
        ...
        return CustomTextFormField(
          ...
          hintText: cubit.phoneCheckoutController.text.isEmpty ? '${SharedHelper.get(key: SharedKey.phone)}' : 'Phone',
          labelText: cubit.phoneCheckoutController.text.isEmpty
              ? 'Phone'
              : cubit.phoneCheckoutController.text,
